...
pub const DAY_IN_SECONDS: u32 = 60 * 60 * 24;
...
// FEES
pub const MAX_INDEX_MANAGER_FEE_BPS: u32 = 1000; // Maximum fee: 10% (in basis points)
pub const SECONDS_IN_A_YEAR: u32 = 365 * 24 * 60 * 60 * 100;
