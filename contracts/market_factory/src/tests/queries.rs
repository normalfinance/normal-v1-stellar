...
#[test]
fn test_deploy_multiple_markets() {
    let env = Env::default();
...
fn test_queries_by_tuple() {
    ...
    let first_market_params = MarketParams {
        admin: admin.clone(),
        // ...
    };

    let second_market_params = MarketParams {
        admin: admin.clone(),
        // ...
    };

    let third_market_params = MarketParams {
        admin: admin.clone(),
        // ...
    };

    let market_contract_addr = factory.create_market(
        &admin.clone(),
        &quoteTokenAddress,
        &first_market_params,
        "",
