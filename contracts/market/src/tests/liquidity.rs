...
use super::setup::{deploy_synth_pool_contract, deploy_token_contract};
use crate::{
...
fn provide_liquidity() {
    ...
    let swap_fees = 0i64;
    let pool = deploy_synth_pool_contract(
        &env,
        None,
    ...
    let lp_token_address = pool.query_lp_token_address();
    let token_share = token_contract::Client::new(&env, &lp_token_address);
    ...
    pool.create_position(tick_lower_index, tick_upper_index);
    pool.increase_liquidity(&user1);
    // pool.increase_liquidity(
    //     &user1,
...
fn withdraw_liquidity() {
    ...
    pool.decrease_liquidity(&user1, &share_amount, &min_a, &min_b, &None::<u64>);
    ...
    assert_eq!(
        ...
        PoolResponse {
            ...
            asset_lp_share: Asset {
                address: lp_token_address.clone(),
                amount: 500_000_000_000_000_i128,
            },
            stake_address: result.clone().stake_address,
        }
...
fn query_share_valid_liquidity() {
    ...
    let lp_token_address = pool.query_lp_token_address();
    let token_share = token_contract::Client::new(&env, &lp_token_address.clone());
...
fn test_query_info_for_factory_works() {
    ...
    assert_eq!(
        ...
        PoolResponse {
            ...
            asset_lp_share: Asset {
                address: pool.query_lp_token_address(),
                amount: 0
            },
