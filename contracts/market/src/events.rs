...
impl MarketEvents {
    ...
    pub fn collateral_deposit(
        ...
        env.events().publish(topics, (user, collateral_type, amount));
    }
    ...
    pub fn collateral_loan(
        ...
        env.events().publish(topics, (user, loan_contract, collateral_type, amount, executor));
    }
...
impl PoolEvents {
    ...
    pub fn init(
        ...
        env.events().publish(topics, (initial_sqrt_price, fee_rate, protocol_fee_rate));
    }
    ...
    pub fn increase_liquidity(
        ...
        let topics = (Symbol::new(&env, "increase_liquidity"), user, token_a, token_b);
    ...
    pub fn remove_liquidity(
        ...
        let topics = (Symbol::new(&env, "remove_liquidity"), user, token_a, token_b);
        env.events().publish(topics, (amount_a, amount_b));
    }
