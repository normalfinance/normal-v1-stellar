use normal::{
    ...
    }, error::{ErrorCode, NormalResult}, math::{casting::Cast, safe_math::SafeMath}, oracle::OracleSource, types::SynthTier
};
use soroban_sdk::{
    contracttype, log, xdr::ToXdr, Address, Bytes, BytesN, ConversionError, Env, Map, TryFromVal,
    Val, Vec,
};

use crate::{
    math::token_math::{MAX_FEE_RATE, MAX_PROTOCOL_FEE_RATE},
